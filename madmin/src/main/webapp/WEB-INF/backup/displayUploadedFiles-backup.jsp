						...
						<div class="col-md-4">
							...
							<div class="panel-body">
								<table class="display table table-bordered table-striped" id="datatable-aja">
									<thead>
										<tr>											
											<th width="25%" class="text-center">Prayer Time Files</th>											
										</tr>
									</thead>
									<tbody>
										<c:forEach var="file" items="${uploadedfiles}">		
											<c:if test="${file.category == 'PrayerTimes' }">								
												<tr>											
													<td><a target="_blank" href="displayPtPDFFiles/${file}">${file.displayName}</a></td>											
												</tr>		
											</c:if>																				
										</c:forEach>
									</tbody>
								...
								<table class="display table table-bordered table-striped" id="datatable-aja">
									<thead>
										<tr>											
											<th width="25%" class="text-center">Ramadan Files</th>											
										</tr>
									</thead>
									<tbody>
										<c:forEach var="file" items="${uploadedfiles}">	
								...
								<table class="display table table-bordered table-striped" id="datatable-aja">
									<thead>
										<tr>											
											<th width="25%" class="text-center">Misc Files</th>											
										</tr>
									</thead>
									<tbody>
										<c:forEach var="file" items="${uploadedfiles}">	
