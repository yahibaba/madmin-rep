						...
						<section class="panel">
							...
							<div class="panel-body">
								<table class="display table table-bordered table-striped" id="datatable-aja">
									...
									<tbody>
										<c:forEach var="exp" items="${timesList}">										
											<tr>
											<td>${exp.expenseId}</td>
											<td>${exp.date}</td>
											<td>${exp.amount}</td>
											<td>
											<a href="${pageContext.request.contextPath}/shop/edit/${exp.expenseId}.html">Edit</a><br/>
											<a href="${pageContext.request.contextPath}/shop/delete/${exp.expenseId}.html">Delete</a><br/>
											</td>
											</tr>																						
										</c:forEach>
									</tbody>
